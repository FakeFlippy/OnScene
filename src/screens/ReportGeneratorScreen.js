...
export default function ReportGeneratorScreen({ navigation }) {
  ...
  const handleTranscriptionComplete = (transcribedText, audioUri) => {
    setReportText(transcribedText);
    setCurrentAudioUri(audioUri);
    setIsEditing(true);
    Alert.alert(
      'Transcription Complete',
      'Your voice recording has been converted to text. You can now edit the report.',
      [{ text: 'OK' }]
    );
  };
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.instructionsSection}>
            ...
            <Text style={styles.instructionsText}>
              1. Tap the microphone to start recording your field report{'\n'}
              2. Speak clearly about the incident, patient status, and actions taken{'\n'}
              3. Stop recording when finished - the audio will be transcribed automatically{'\n'}
              4. Edit the transcribed text as needed{'\n'}
              5. Save or export your report for later use
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
